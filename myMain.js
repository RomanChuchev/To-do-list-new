...
function createTodoItem(name) {
    ...
    // Добавляю классы
    todoItem.classList.add('form-check-label', 'list-group-item', 'd-flex', 'justify-content-between', 'align-items-center')
    doneCheck.classList.add('form-check', 'form-check-input', 'check-check')
    deleteBtn.classList.add('btn', 'btn-primary', 'mb-2', 'btn-danger')
...
function createTodoApp(container, tittle, key) {
    ...
    if (localStorage.getItem(key)) {
        ...
        for (const obj of todoArray) {
            ...
            deleteTodoItem(todoItem.todoItem, todoItem.deleteBtn, todoItem.todoItemForm)
