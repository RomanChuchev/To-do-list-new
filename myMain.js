...
// Функция, создающая ul список. Нужна ли она?
...
function createTodoApp(container, tittle, key) {
    ...
    appForm.form.addEventListener('submit', e => {
        // Чтобы страница не перезагружалась при отправка, нужно прописать:
        e.preventDefault()
